...
def init_superuser():
    ...
    # Skip LLM testing in development mode to avoid configuration issues
    try:
        ...
        logging.warning(f"LLM testing skipped during initialization: {e}")
        logging.info("This is normal in development mode without LLM configuration.")
